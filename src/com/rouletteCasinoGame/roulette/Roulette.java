...
import static com.rouletteCasinoGame.RouletteGameMessages.getString;
import static com.rouletteCasinoGame.RouletteGameMessages.WINNING_NUMBER;
...
public class Roulette extends Game {
    ...
    public Roulette(final FilesRepository csvFileFilesRepository) throws GameException {
        super(csvFileFilesRepository, new RouletteBetTargetFactory());
    ...
    public String gameResultToString(final GameResult result) {
        ...
        gameResult.append(winningNumberHeader(result))
                  .append(MessageShowToUser.defaultGameResultHeader());
    ...
    private String winningNumberHeader(GameResult result) {
        ...
        return getString(WINNING_NUMBER.name(), winningTargets.toString());
    }

    @Override
    protected BetFactory betFactory() {
        return new RouletteBet(this);
    }
